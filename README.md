...
**Related (horizontal):** [stubborn](https://github.com/stubborn-ai/stubborn) compiles SCIP symbol graphs into token-bounded LLM stubs. It complements — does not replace — this exporter for crosswalk, Explorer, or rewrite. See [ADR-010](https://github.com/anchor-migration/migration-hub/blob/main/docs/ADR-010-stubborn-integration.md).
...
│   └── mybatis/          # Profile mybatis (mapper XML, SQL artifacts)
...
| Profile | `schema/profiles/mybatis/v1.sql` | `mybatis_result_map`, `mybatis_result_field`, `mybatis_statement`, … |
